...
namespace xpand3
{
    namespace declaration
    {
        ...
        class DeclarationPackage: public virtual ::ecore::EPackage
        {
        public:
            ...
            static const int ABSTRACTDECLARATION__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int ABSTRACTDECLARATION__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int ABSTRACTDECLARATION__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int ABSTRACTDECLARATION__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;

            // IDs for classifiers for class AbstractNamedDeclaration 

            static const int ABSTRACTNAMEDDECLARATION__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int ABSTRACTNAMEDDECLARATION__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int ABSTRACTNAMEDDECLARATION__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int ABSTRACTNAMEDDECLARATION__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;

            static const int ABSTRACTNAMEDDECLARATION__OWNER =
                    ABSTRACTDECLARATION__OWNER;

            static const int ABSTRACTNAMEDDECLARATION__PARAMS =
                    ABSTRACTDECLARATION__PARAMS;

            static const int ABSTRACTNAMEDDECLARATION__ISPRIVATE =
                    ABSTRACTDECLARATION__ISPRIVATE;

            static const int ABSTRACTNAMEDDECLARATION__GUARD =
                    ABSTRACTDECLARATION__GUARD;

            // IDs for classifiers for class Check 

            static const int CHECK__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int CHECK__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int CHECK__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int CHECK__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;
            ...
            static const int CREATEEXTENSION__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int CREATEEXTENSION__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int CREATEEXTENSION__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;
            ...
            static const int DEFINITION__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int DEFINITION__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int DEFINITION__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int DEFINITION__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;
            ...
            static const int DEFINITION__ISPRIVATE =
                    ABSTRACTDECLARATION__ISPRIVATE;
            ...
            static const int DEFINITIONASPECT__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int DEFINITIONASPECT__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int DEFINITIONASPECT__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int DEFINITIONASPECT__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;

            static const int DEFINITIONASPECT__OWNER =
                    ABSTRACTDECLARATION__OWNER;

            static const int DEFINITIONASPECT__PARAMS =
                    ABSTRACTDECLARATION__PARAMS;

            static const int DEFINITIONASPECT__ISPRIVATE =
                    ABSTRACTDECLARATION__ISPRIVATE;

            static const int DEFINITIONASPECT__GUARD =
                    ABSTRACTDECLARATION__GUARD;

            static const int DEFINITIONASPECT__POINTCUT =
                    ABSTRACTASPECT__POINTCUT;

            static const int DEFINITIONASPECT__WILDPARAMS =
                    ABSTRACTASPECT__WILDPARAMS;

            // IDs for classifiers for class Extension 

            static const int EXTENSION__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int EXTENSION__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int EXTENSION__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int EXTENSION__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;
            ...
            static const int EXTENSION__ISPRIVATE =
                    ABSTRACTDECLARATION__ISPRIVATE;
            ...
            static const int EXTENSIONASPECT__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int EXTENSIONASPECT__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int EXTENSIONASPECT__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;
            ...
            static const int EXTENSIONASPECT__WILDPARAMS =
                    ABSTRACTASPECT__WILDPARAMS;

            // IDs for classifiers for class JavaExtension 

            static const int JAVAEXTENSION__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int JAVAEXTENSION__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int JAVAEXTENSION__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int JAVAEXTENSION__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;
            ...
            static const int JAVAEXTENSION__NAME =
                    ABSTRACTNAMEDDECLARATION__NAME;
        ...
        protected:
            ...
            static std::unique_ptr< DeclarationPackage,
                    ::ecorecpp::PackageDeleter< DeclarationPackage > > s_instance;

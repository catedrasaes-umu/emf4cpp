...
#ifndef _DLL_JSON_HPP
#define _DLL_JSON_HPP
/*
 * Defines 3 preprocessor symbols:
 * - MAKE_JSON_DLL  set to 1 when building the dll, else unset
 * - USE_JSON_DLL    set to 1 when using the dll, else unset
 * - EXPORT_JSON_DLL  always set, import when using the dll,
...
#   if defined(MAKE_JSON_DLL)
#       if defined(USE_JSON_DLL)
#           undef USE_JSON_DLL
#       endif

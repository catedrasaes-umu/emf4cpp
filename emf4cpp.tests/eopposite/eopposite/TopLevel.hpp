...
namespace eopposite
{
    ...
    class TopLevel: public virtual ::eopposite::NamedObject
    {
    public:
        TopLevel();
    ...
    protected:
        ...
        ::ecorecpp::mapping::out_ptr<
                ::ecorecpp::mapping::EList< ::eopposite::LeftHand > > m_leftees;

        ::ecorecpp::mapping::out_ptr<
                ::ecorecpp::mapping::EList< ::eopposite::RightHand > > m_rightees;

        ::ecorecpp::mapping::out_ptr<
                ::ecorecpp::mapping::EList< ::eopposite::RightMultiple > > m_rightMultiples;

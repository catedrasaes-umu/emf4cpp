        ...
        ::ecore::EBoolean _resolve)
{
    ...
    {
        _any = m_use->asEListOf< ::ecore::EObject >();
    }
        return _any;
...
void Use::eSet(::ecore::EInt _featureID, ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::SVG::SVGPackage::USE__USE:
    {
        ::ecorecpp::mapping::EList_ptr _t0 = ::ecorecpp::mapping::any::any_cast
                < ::ecorecpp::mapping::EList_ptr > (_newValue);
        ::SVG::Use::getUse().clear();
        ::SVG::Use::getUse().insert_all(*_t0);
    }
        return;
...
::ecore::EClass_ptr Use::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::SVG::SVGPackage_ptr >(::SVG::SVGPackage::_instance())->getUse();
    return _eclass;
}
        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::SVG::SVGPackage::USE__USE:
    {
        ...
        // add to a list
        auto& container = (::ecorecpp::mapping::ReferenceEListImpl<
                ::SVG::Element, -1, false, true >&) ::SVG::Use::getUse();
        container.basicAdd(_t1);
    }
        return;

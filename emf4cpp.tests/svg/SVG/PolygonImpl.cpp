        ...
        ::ecore::EBoolean _resolve)
{
    ...
    {
        _any = m_waypoints->asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::SVG::SVGPackage::POLYGON__WAYPOINTS:
    {
        ::ecorecpp::mapping::EList< ::ecore::EObject_ptr >::ptr_type _t0 =
                ::ecorecpp::mapping::any::any_cast < ::ecorecpp::mapping::EList
                        < ::ecore::EObject_ptr > ::ptr_type > (_newValue);
        ::SVG::Polygon::getWaypoints().clear();
        ::SVG::Polygon::getWaypoints().insert_all(*_t0);
    }
        return;
    case ::SVG::SVGPackage::POLYGON__MARKEREND:
    {
    ...
    case ::SVG::SVGPackage::POLYGON__MARKERSTART:
    {
        ...
        ::ecorecpp::mapping::any_traits < ::PrimitiveTypes::String
                > ::fromAny(_newValue, _t0);
        ::SVG::Polygon::setMarkerStart(_t0);
    }
        return;
...
::ecore::EClass_ptr Polygon::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::SVG::SVGPackage* >(::SVG::SVGPackage::_instance().get())->getPolygon();
    return _eclass;
}

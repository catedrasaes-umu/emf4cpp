        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::source::SourcePackage::INVENTORYRELATIONSHIP__TO:
    {
        ...
        ::kdm::source::InventoryRelationship::setTo(_t1);
    }
        return;
    case ::kdm::source::SourcePackage::INVENTORYRELATIONSHIP__FROM:
    {
        ...
        ::kdm::source::AbstractInventoryElement_ptr _t1 =
                dynamic_cast< ::kdm::source::AbstractInventoryElement_ptr >(_t0);
        ::kdm::source::InventoryRelationship::setFrom(_t1);
    }
        return;
...
::ecore::EClass_ptr InventoryRelationship::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::source::SourcePackage_ptr >(::kdm::source::SourcePackage::_instance())->getInventoryRelationship();
    return _eclass;
}

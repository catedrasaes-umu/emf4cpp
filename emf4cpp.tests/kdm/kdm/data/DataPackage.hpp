...
namespace kdm
{
    namespace data
    {
        ...
        class DataPackage: public virtual ::ecore::EPackage
        {
        public:
            ...
            static const int ABSTRACTCONTENTELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ABSTRACTCONTENTELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ABSTRACTCONTENTELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ABSTRACTCONTENTELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int ABSTRACTCONTENTELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int ABSTRACTCONTENTELEMENT__SOURCE =
                    ABSTRACTDATAELEMENT__SOURCE;

            static const int ABSTRACTCONTENTELEMENT__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int ABSTRACTCONTENTELEMENT__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            // IDs for classifiers for class AbstractDataElement 

            static const int ABSTRACTDATAELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ABSTRACTDATAELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ABSTRACTDATAELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ABSTRACTDATAELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int ABSTRACTDATAELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            // IDs for classifiers for class AbstractDataRelationship 

            static const int ABSTRACTDATARELATIONSHIP__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ABSTRACTDATARELATIONSHIP__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ABSTRACTDATARELATIONSHIP__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ABSTRACTDATARELATIONSHIP__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class AllContent 

            static const int ALLCONTENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ALLCONTENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ALLCONTENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ALLCONTENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int ALLCONTENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int ALLCONTENT__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int ALLCONTENT__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int ALLCONTENT__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int ALLCONTENT__CONTENTELEMENT =
                    COMPLEXCONTENTTYPE__CONTENTELEMENT;

            // IDs for classifiers for class Catalog 

            static const int CATALOG__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CATALOG__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CATALOG__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CATALOG__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int CATALOG__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int CATALOG__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int CATALOG__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int CATALOG__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;
            ...
            static const int CHOICECONTENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CHOICECONTENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CHOICECONTENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CHOICECONTENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;
            ...
            static const int CHOICECONTENT__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int CHOICECONTENT__CONTENTELEMENT =
                    COMPLEXCONTENTTYPE__CONTENTELEMENT;

            // IDs for classifiers for class ColumnSet 

            static const int COLUMNSET__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int COLUMNSET__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int COLUMNSET__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int COLUMNSET__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int COLUMNSET__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int COLUMNSET__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int COLUMNSET__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;
            ...
            static const int COMPLEXCONTENTTYPE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int COMPLEXCONTENTTYPE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int COMPLEXCONTENTTYPE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int COMPLEXCONTENTTYPE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int COMPLEXCONTENTTYPE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int COMPLEXCONTENTTYPE__SOURCE =
                    ABSTRACTDATAELEMENT__SOURCE;

            static const int COMPLEXCONTENTTYPE__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int COMPLEXCONTENTTYPE__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            // IDs for classifiers for class ContentAttribute 

            static const int CONTENTATTRIBUTE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CONTENTATTRIBUTE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CONTENTATTRIBUTE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CONTENTATTRIBUTE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int CONTENTATTRIBUTE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int CONTENTATTRIBUTE__SOURCE =
                    ABSTRACTDATAELEMENT__SOURCE;

            static const int CONTENTATTRIBUTE__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int CONTENTATTRIBUTE__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int CONTENTATTRIBUTE__TYPE = CONTENTITEM__TYPE;

            static const int CONTENTATTRIBUTE__CONTENTELEMENT =
                    CONTENTITEM__CONTENTELEMENT;

            // IDs for classifiers for class ContentElement 

            static const int CONTENTELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CONTENTELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CONTENTELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CONTENTELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int CONTENTELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int CONTENTELEMENT__SOURCE =
                    ABSTRACTDATAELEMENT__SOURCE;

            static const int CONTENTELEMENT__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int CONTENTELEMENT__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int CONTENTELEMENT__TYPE = CONTENTITEM__TYPE;

            static const int CONTENTELEMENT__CONTENTELEMENT =
                    CONTENTITEM__CONTENTELEMENT;

            // IDs for classifiers for class ContentItem 

            static const int CONTENTITEM__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CONTENTITEM__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CONTENTITEM__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CONTENTITEM__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int CONTENTITEM__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int CONTENTITEM__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int CONTENTITEM__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int CONTENTITEM__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            // IDs for classifiers for class ContentReference 

            static const int CONTENTREFERENCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CONTENTREFERENCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CONTENTREFERENCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CONTENTREFERENCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int CONTENTREFERENCE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int CONTENTREFERENCE__SOURCE =
                    ABSTRACTDATAELEMENT__SOURCE;

            static const int CONTENTREFERENCE__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int CONTENTREFERENCE__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int CONTENTREFERENCE__TYPE = CONTENTITEM__TYPE;

            static const int CONTENTREFERENCE__CONTENTELEMENT =
                    CONTENTITEM__CONTENTELEMENT;

            // IDs for classifiers for class ContentRestriction 

            static const int CONTENTRESTRICTION__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CONTENTRESTRICTION__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CONTENTRESTRICTION__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CONTENTRESTRICTION__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int CONTENTRESTRICTION__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int CONTENTRESTRICTION__SOURCE =
                    ABSTRACTDATAELEMENT__SOURCE;

            static const int CONTENTRESTRICTION__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int CONTENTRESTRICTION__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            // IDs for classifiers for class DataAction 

            static const int DATAACTION__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DATAACTION__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DATAACTION__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DATAACTION__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int DATAACTION__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int DATAACTION__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int DATAACTION__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int DATAACTION__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            // IDs for classifiers for class DataContainer 

            static const int DATACONTAINER__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DATACONTAINER__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DATACONTAINER__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DATACONTAINER__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;
            ...
            static const int DATACONTAINER__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            // IDs for classifiers for class DataEvent 

            static const int DATAEVENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DATAEVENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DATAEVENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DATAEVENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int DATAEVENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int DATAEVENT__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int DATAEVENT__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int DATAEVENT__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            // IDs for classifiers for class DataModel 

            static const int DATAMODEL__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DATAMODEL__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DATAMODEL__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DATAMODEL__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int DATAMODEL__AUDIT =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__AUDIT;

            static const int DATAMODEL__EXTENSIONFAMILY =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__EXTENSIONFAMILY;

            static const int DATAMODEL__NAME =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__NAME;

            // IDs for classifiers for class DataRelationship 

            static const int DATARELATIONSHIP__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DATARELATIONSHIP__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DATARELATIONSHIP__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DATARELATIONSHIP__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class DataResource 

            static const int DATARESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DATARESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DATARESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DATARESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int DATARESOURCE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int DATARESOURCE__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int DATARESOURCE__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int DATARESOURCE__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            // IDs for classifiers for class DataSegment 

            static const int DATASEGMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DATASEGMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DATASEGMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DATASEGMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int DATASEGMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int DATASEGMENT__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int DATASEGMENT__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int DATASEGMENT__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int DATASEGMENT__DATAELEMENT =
            ...
            static const int DATATYPEOF__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DATATYPEOF__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DATATYPEOF__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DATATYPEOF__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class ExtendedDataElement 

            static const int EXTENDEDDATAELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int EXTENDEDDATAELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int EXTENDEDDATAELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int EXTENDEDDATAELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int EXTENDEDDATAELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int EXTENDEDDATAELEMENT__SOURCE =
                    ABSTRACTDATAELEMENT__SOURCE;

            static const int EXTENDEDDATAELEMENT__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int EXTENDEDDATAELEMENT__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            // IDs for classifiers for class ExtensionTo 

            static const int EXTENSIONTO__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int EXTENSIONTO__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int EXTENSIONTO__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int EXTENSIONTO__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class GroupContent 

            static const int GROUPCONTENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int GROUPCONTENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int GROUPCONTENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int GROUPCONTENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int GROUPCONTENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int GROUPCONTENT__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int GROUPCONTENT__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int GROUPCONTENT__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int GROUPCONTENT__TYPE = CONTENTITEM__TYPE;

            static const int GROUPCONTENT__CONTENTELEMENT =
                    CONTENTITEM__CONTENTELEMENT;

            // IDs for classifiers for class HasContent 

            static const int HASCONTENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int HASCONTENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int HASCONTENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int HASCONTENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class Index 

            static const int INDEX__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int INDEX__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int INDEX__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int INDEX__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int INDEX__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int INDEX__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int INDEX__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int INDEX__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int INDEX__IMPLEMENTATION =
                    INDEXELEMENT__IMPLEMENTATION;

            // IDs for classifiers for class IndexElement 

            static const int INDEXELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int INDEXELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int INDEXELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int INDEXELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int INDEXELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int INDEXELEMENT__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int INDEXELEMENT__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int INDEXELEMENT__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            // IDs for classifiers for class KeyRelation 

            static const int KEYRELATION__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int KEYRELATION__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int KEYRELATION__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int KEYRELATION__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class ManagesData 

            static const int MANAGESDATA__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int MANAGESDATA__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int MANAGESDATA__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int MANAGESDATA__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class MixedContent 

            static const int MIXEDCONTENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int MIXEDCONTENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int MIXEDCONTENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int MIXEDCONTENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int MIXEDCONTENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int MIXEDCONTENT__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int MIXEDCONTENT__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int MIXEDCONTENT__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int MIXEDCONTENT__CONTENTELEMENT =
                    COMPLEXCONTENTTYPE__CONTENTELEMENT;

            // IDs for classifiers for class ProducesDataEvent 

            static const int PRODUCESDATAEVENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int PRODUCESDATAEVENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int PRODUCESDATAEVENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int PRODUCESDATAEVENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class ReadsColumnSet 

            static const int READSCOLUMNSET__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int READSCOLUMNSET__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int READSCOLUMNSET__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int READSCOLUMNSET__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class RecordFile 

            static const int RECORDFILE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int RECORDFILE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int RECORDFILE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int RECORDFILE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int RECORDFILE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int RECORDFILE__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int RECORDFILE__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int RECORDFILE__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int RECORDFILE__DATAELEMENT =
                    DATACONTAINER__DATAELEMENT;
            ...
            static const int REFERENCEKEY__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int REFERENCEKEY__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int REFERENCEKEY__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int REFERENCEKEY__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int REFERENCEKEY__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int REFERENCEKEY__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int REFERENCEKEY__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int REFERENCEKEY__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int REFERENCEKEY__IMPLEMENTATION =
                    INDEXELEMENT__IMPLEMENTATION;

            // IDs for classifiers for class ReferenceTo 

            static const int REFERENCETO__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int REFERENCETO__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int REFERENCETO__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int REFERENCETO__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class RelationalSchema 

            static const int RELATIONALSCHEMA__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int RELATIONALSCHEMA__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int RELATIONALSCHEMA__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int RELATIONALSCHEMA__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int RELATIONALSCHEMA__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int RELATIONALSCHEMA__SOURCE =
                    ABSTRACTDATAELEMENT__SOURCE;

            static const int RELATIONALSCHEMA__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int RELATIONALSCHEMA__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int RELATIONALSCHEMA__DATAELEMENT =
                    DATACONTAINER__DATAELEMENT;

            // IDs for classifiers for class RelationalTable 

            static const int RELATIONALTABLE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int RELATIONALTABLE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int RELATIONALTABLE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int RELATIONALTABLE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int RELATIONALTABLE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int RELATIONALTABLE__SOURCE =
                    ABSTRACTDATAELEMENT__SOURCE;

            static const int RELATIONALTABLE__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int RELATIONALTABLE__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int RELATIONALTABLE__DATAELEMENT =
                    DATACONTAINER__DATAELEMENT;
            ...
            static const int RELATIONALVIEW__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int RELATIONALVIEW__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int RELATIONALVIEW__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int RELATIONALVIEW__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int RELATIONALVIEW__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int RELATIONALVIEW__SOURCE =
                    ABSTRACTDATAELEMENT__SOURCE;

            static const int RELATIONALVIEW__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int RELATIONALVIEW__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int RELATIONALVIEW__DATAELEMENT =
                    DATACONTAINER__DATAELEMENT;
            ...
            static const int RESTRICTIONOF__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int RESTRICTIONOF__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int RESTRICTIONOF__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int RESTRICTIONOF__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class SeqContent 

            static const int SEQCONTENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int SEQCONTENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int SEQCONTENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int SEQCONTENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int SEQCONTENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int SEQCONTENT__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int SEQCONTENT__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int SEQCONTENT__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int SEQCONTENT__CONTENTELEMENT =
                    COMPLEXCONTENTTYPE__CONTENTELEMENT;

            // IDs for classifiers for class SimpleContentType 

            static const int SIMPLECONTENTTYPE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int SIMPLECONTENTTYPE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int SIMPLECONTENTTYPE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int SIMPLECONTENTTYPE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int SIMPLECONTENTTYPE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int SIMPLECONTENTTYPE__SOURCE =
                    ABSTRACTDATAELEMENT__SOURCE;

            static const int SIMPLECONTENTTYPE__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int SIMPLECONTENTTYPE__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int SIMPLECONTENTTYPE__CONTENTELEMENT =
                    COMPLEXCONTENTTYPE__CONTENTELEMENT;

            // IDs for classifiers for class TypedBy 

            static const int TYPEDBY__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int TYPEDBY__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int TYPEDBY__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int TYPEDBY__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class UniqueKey 

            static const int UNIQUEKEY__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int UNIQUEKEY__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int UNIQUEKEY__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int UNIQUEKEY__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int UNIQUEKEY__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int UNIQUEKEY__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int UNIQUEKEY__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int UNIQUEKEY__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;

            static const int UNIQUEKEY__IMPLEMENTATION =
                    INDEXELEMENT__IMPLEMENTATION;

            // IDs for classifiers for class WritesColumnSet 

            static const int WRITESCOLUMNSET__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int WRITESCOLUMNSET__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int WRITESCOLUMNSET__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int WRITESCOLUMNSET__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class XMLSchema 

            static const int XMLSCHEMA__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int XMLSCHEMA__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int XMLSCHEMA__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int XMLSCHEMA__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int XMLSCHEMA__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int XMLSCHEMA__SOURCE = ABSTRACTDATAELEMENT__SOURCE;

            static const int XMLSCHEMA__DATARELATION =
                    ABSTRACTDATAELEMENT__DATARELATION;

            static const int XMLSCHEMA__ABSTRACTION =
                    ABSTRACTDATAELEMENT__ABSTRACTION;
        ...
        protected:
            ...
            static std::unique_ptr< DataPackage,
                    ::ecorecpp::PackageDeleter< DataPackage > > s_instance;

        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::data::DataPackage::RELATIONALSCHEMA__CODEELEMENT:
    {
        ::ecorecpp::mapping::EList_ptr _t0 = ::ecorecpp::mapping::any::any_cast
                < ::ecorecpp::mapping::EList_ptr > (_newValue);
        ::kdm::data::RelationalSchema::getCodeElement().clear();
        ::kdm::data::RelationalSchema::getCodeElement().insert_all(*_t0);
    }
        return;
...
::ecore::EClass_ptr RelationalSchema::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::data::DataPackage_ptr >(::kdm::data::DataPackage::_instance())->getRelationalSchema();
    return _eclass;
}

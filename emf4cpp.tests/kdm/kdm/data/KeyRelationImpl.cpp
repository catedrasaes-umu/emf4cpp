        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::data::DataPackage::KEYRELATION__TO:
    {
        ...
        ::kdm::data::UniqueKey_ptr _t1 =
                dynamic_cast< ::kdm::data::UniqueKey_ptr >(_t0);
    ...
    case ::kdm::data::DataPackage::KEYRELATION__FROM:
    {
        ...
        ::kdm::data::ReferenceKey_ptr _t1 =
                dynamic_cast< ::kdm::data::ReferenceKey_ptr >(_t0);
...
::ecore::EClass_ptr KeyRelation::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::data::DataPackage_ptr >(::kdm::data::DataPackage::_instance())->getKeyRelation();
    return _eclass;
}

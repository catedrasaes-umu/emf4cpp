        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::data::DataPackage::READSCOLUMNSET__TO:
    {
        ...
        ::kdm::data::ReadsColumnSet::setTo(_t1);
    }
        return;
    case ::kdm::data::DataPackage::READSCOLUMNSET__FROM:
    {
        ...
        ::kdm::data::ReadsColumnSet::setFrom(_t1);
    }
        return;
...
::ecore::EClass_ptr ReadsColumnSet::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::data::DataPackage* >(::kdm::data::DataPackage::_instance().get())->getReadsColumnSet();
    return _eclass;
}

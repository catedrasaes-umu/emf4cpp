...
namespace kdm
{
    namespace kdm
    {
        ...
        public:
            ...
            static const int ANNOTATION__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ANNOTATION__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            // IDs for classifiers for class Attribute 

            static const int ATTRIBUTE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ATTRIBUTE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            // IDs for classifiers for class Audit 

            static const int AUDIT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int AUDIT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            // IDs for classifiers for class ExtendedValue 

            static const int EXTENDEDVALUE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int EXTENDEDVALUE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            // IDs for classifiers for class ExtensionFamily 

            static const int EXTENSIONFAMILY__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int EXTENSIONFAMILY__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            // IDs for classifiers for class KDMFramework 

            static const int KDMFRAMEWORK__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int KDMFRAMEWORK__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int KDMFRAMEWORK__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int KDMFRAMEWORK__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class KDMModel 

            static const int KDMMODEL__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int KDMMODEL__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int KDMMODEL__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int KDMMODEL__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int KDMMODEL__AUDIT = KDMFRAMEWORK__AUDIT;

            static const int KDMMODEL__EXTENSIONFAMILY =
                    KDMFRAMEWORK__EXTENSIONFAMILY;

            static const int KDMMODEL__NAME = KDMFRAMEWORK__NAME;

            // IDs for classifiers for class Segment 

            static const int SEGMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int SEGMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int SEGMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int SEGMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int SEGMENT__AUDIT = KDMFRAMEWORK__AUDIT;

            static const int SEGMENT__EXTENSIONFAMILY =
                    KDMFRAMEWORK__EXTENSIONFAMILY;
            ...
            static const int STEREOTYPE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int STEREOTYPE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            // IDs for classifiers for class TagDefinition 

            static const int TAGDEFINITION__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int TAGDEFINITION__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            // IDs for classifiers for class TaggedRef 

            static const int TAGGEDREF__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int TAGGEDREF__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;
            ...
            static const int TAGGEDVALUE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int TAGGEDVALUE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;
        ...
        protected:
            ...
            static std::unique_ptr< KdmPackage,
                    ::ecorecpp::PackageDeleter< KdmPackage > > s_instance;

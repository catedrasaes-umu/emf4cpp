        ...
        ::ecore::EBoolean _resolve)
{
    ...
    {
        _any = m_groupedCode->asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::platform::PlatformPackage::DEPLOYEDCOMPONENT__GROUPEDCODE:
    {
        ::ecorecpp::mapping::EList< ::ecore::EObject_ptr >::ptr_type _t0 =
                ::ecorecpp::mapping::any::any_cast < ::ecorecpp::mapping::EList
                        < ::ecore::EObject_ptr > ::ptr_type > (_newValue);
        ::kdm::platform::DeployedComponent::getGroupedCode().clear();
        ::kdm::platform::DeployedComponent::getGroupedCode().insert_all(*_t0);
    }
        return;
...
::ecore::EBoolean DeployedComponent::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::kdm::platform::PlatformPackage::DEPLOYEDCOMPONENT__GROUPEDCODE:
        return m_groupedCode && m_groupedCode->size();
...
::ecore::EClass_ptr DeployedComponent::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::platform::PlatformPackage* >(::kdm::platform::PlatformPackage::_instance().get())->getDeployedComponent();
    return _eclass;
}

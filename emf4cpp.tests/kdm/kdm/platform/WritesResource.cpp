...
void WritesResource::setTo(::kdm::platform::ResourceType_ptr _to)
{
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ...
                (::ecore::EStructuralFeature_ptr) ::kdm::platform::PlatformPackage::_instance()->getWritesResource__to(),
                _old_to,
                m_to
        );
...
void WritesResource::setFrom(::kdm::action::ActionElement_ptr _from)
{
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ::ecorecpp::notify::Notification::SET,
                (::ecore::EObject_ptr) this,
                (::ecore::EStructuralFeature_ptr) ::kdm::platform::PlatformPackage::_instance()->getWritesResource__from(),
                _old_from,
                m_from
        );
        eNotify(&notification);

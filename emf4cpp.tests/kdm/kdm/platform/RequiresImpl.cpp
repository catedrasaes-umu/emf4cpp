        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::platform::PlatformPackage::REQUIRES__FROM:
    {
        ...
        ::kdm::platform::DeployedComponent_ptr _t1 =
                dynamic_cast< ::kdm::platform::DeployedComponent* >(_t0.get()); /*/// std::dynamic_pointer_cast< ::kdm::platform::DeployedComponent >(_t0);*/
...
::ecore::EClass_ptr Requires::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::platform::PlatformPackage* >(::kdm::platform::PlatformPackage::_instance().get())->getRequires();
    return _eclass;
}

        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::platform::PlatformPackage::SPAWNS__TO:
    {
        ...
        ::kdm::platform::RuntimeResource_ptr _t1 =
                dynamic_cast< ::kdm::platform::RuntimeResource* >(_t0.get()); /*/// std::dynamic_pointer_cast< ::kdm::platform::RuntimeResource >(_t0);*/
        ::kdm::platform::Spawns::setTo(_t1);
    }
        return;
    case ::kdm::platform::PlatformPackage::SPAWNS__FROM:
    {
        ...
        ::kdm::platform::Spawns::setFrom(_t1);
    }
        return;
...
::ecore::EClass_ptr Spawns::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::platform::PlatformPackage* >(::kdm::platform::PlatformPackage::_instance().get())->getSpawns();
    return _eclass;
}

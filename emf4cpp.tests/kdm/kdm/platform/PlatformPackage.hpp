...
namespace kdm
{
    namespace platform
    {
        ...
        class PlatformPackage: public virtual ::ecore::EPackage
        {
        public:
            ...
            static const int ABSTRACTPLATFORMELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ABSTRACTPLATFORMELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ABSTRACTPLATFORMELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ABSTRACTPLATFORMELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int ABSTRACTPLATFORMELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            // IDs for classifiers for class AbstractPlatformRelationship 

            static const int ABSTRACTPLATFORMRELATIONSHIP__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ABSTRACTPLATFORMRELATIONSHIP__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ABSTRACTPLATFORMRELATIONSHIP__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ABSTRACTPLATFORMRELATIONSHIP__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class BindsTo 

            static const int BINDSTO__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int BINDSTO__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int BINDSTO__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int BINDSTO__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class DataManager 

            static const int DATAMANAGER__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DATAMANAGER__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DATAMANAGER__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DATAMANAGER__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int DATAMANAGER__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int DATAMANAGER__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int DATAMANAGER__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int DATAMANAGER__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int DATAMANAGER__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            static const int DATAMANAGER__PLATFORMELEMENT =
                    RESOURCETYPE__PLATFORMELEMENT;

            // IDs for classifiers for class DefinedBy 

            static const int DEFINEDBY__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DEFINEDBY__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DEFINEDBY__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DEFINEDBY__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class DeployedComponent 

            static const int DEPLOYEDCOMPONENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DEPLOYEDCOMPONENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DEPLOYEDCOMPONENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DEPLOYEDCOMPONENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int DEPLOYEDCOMPONENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int DEPLOYEDCOMPONENT__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int DEPLOYEDCOMPONENT__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int DEPLOYEDCOMPONENT__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int DEPLOYEDCOMPONENT__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            // IDs for classifiers for class DeployedResource 

            static const int DEPLOYEDRESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DEPLOYEDRESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DEPLOYEDRESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DEPLOYEDRESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int DEPLOYEDRESOURCE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int DEPLOYEDRESOURCE__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int DEPLOYEDRESOURCE__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int DEPLOYEDRESOURCE__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int DEPLOYEDRESOURCE__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            // IDs for classifiers for class DeployedSoftwareSystem 

            static const int DEPLOYEDSOFTWARESYSTEM__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DEPLOYEDSOFTWARESYSTEM__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DEPLOYEDSOFTWARESYSTEM__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DEPLOYEDSOFTWARESYSTEM__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int DEPLOYEDSOFTWARESYSTEM__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int DEPLOYEDSOFTWARESYSTEM__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int DEPLOYEDSOFTWARESYSTEM__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int DEPLOYEDSOFTWARESYSTEM__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int DEPLOYEDSOFTWARESYSTEM__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            // IDs for classifiers for class ExecutionResource 

            static const int EXECUTIONRESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int EXECUTIONRESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int EXECUTIONRESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int EXECUTIONRESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int EXECUTIONRESOURCE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int EXECUTIONRESOURCE__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int EXECUTIONRESOURCE__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int EXECUTIONRESOURCE__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int EXECUTIONRESOURCE__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            static const int EXECUTIONRESOURCE__PLATFORMELEMENT =
                    RESOURCETYPE__PLATFORMELEMENT;

            // IDs for classifiers for class ExternalActor 

            static const int EXTERNALACTOR__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int EXTERNALACTOR__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int EXTERNALACTOR__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int EXTERNALACTOR__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int EXTERNALACTOR__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int EXTERNALACTOR__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int EXTERNALACTOR__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int EXTERNALACTOR__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int EXTERNALACTOR__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            static const int EXTERNALACTOR__KIND = PLATFORMACTION__KIND;

            static const int EXTERNALACTOR__PLATFORMELEMENT =
                    PLATFORMACTION__PLATFORMELEMENT;

            // IDs for classifiers for class FileResource 

            static const int FILERESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int FILERESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int FILERESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int FILERESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int FILERESOURCE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int FILERESOURCE__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int FILERESOURCE__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int FILERESOURCE__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int FILERESOURCE__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            static const int FILERESOURCE__PLATFORMELEMENT =
                    RESOURCETYPE__PLATFORMELEMENT;

            // IDs for classifiers for class Loads 

            static const int LOADS__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int LOADS__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int LOADS__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int LOADS__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class LockResource 

            static const int LOCKRESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int LOCKRESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int LOCKRESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int LOCKRESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int LOCKRESOURCE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int LOCKRESOURCE__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int LOCKRESOURCE__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int LOCKRESOURCE__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int LOCKRESOURCE__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            static const int LOCKRESOURCE__PLATFORMELEMENT =
                    RESOURCETYPE__PLATFORMELEMENT;

            // IDs for classifiers for class Machine 

            static const int MACHINE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int MACHINE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int MACHINE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int MACHINE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int MACHINE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int MACHINE__SOURCE = ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int MACHINE__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int MACHINE__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int MACHINE__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            // IDs for classifiers for class ManagesResource 

            static const int MANAGESRESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int MANAGESRESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int MANAGESRESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int MANAGESRESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class MarshalledResource 

            static const int MARSHALLEDRESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int MARSHALLEDRESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int MARSHALLEDRESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int MARSHALLEDRESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int MARSHALLEDRESOURCE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int MARSHALLEDRESOURCE__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int MARSHALLEDRESOURCE__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int MARSHALLEDRESOURCE__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int MARSHALLEDRESOURCE__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            static const int MARSHALLEDRESOURCE__PLATFORMELEMENT =
                    RESOURCETYPE__PLATFORMELEMENT;

            // IDs for classifiers for class MessagingResource 

            static const int MESSAGINGRESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int MESSAGINGRESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int MESSAGINGRESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int MESSAGINGRESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int MESSAGINGRESOURCE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int MESSAGINGRESOURCE__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int MESSAGINGRESOURCE__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int MESSAGINGRESOURCE__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int MESSAGINGRESOURCE__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            static const int MESSAGINGRESOURCE__PLATFORMELEMENT =
                    RESOURCETYPE__PLATFORMELEMENT;

            // IDs for classifiers for class NamingResource 

            static const int NAMINGRESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int NAMINGRESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int NAMINGRESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int NAMINGRESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int NAMINGRESOURCE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int NAMINGRESOURCE__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int NAMINGRESOURCE__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int NAMINGRESOURCE__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int NAMINGRESOURCE__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            static const int NAMINGRESOURCE__PLATFORMELEMENT =
                    RESOURCETYPE__PLATFORMELEMENT;

            // IDs for classifiers for class PlatformAction 

            static const int PLATFORMACTION__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int PLATFORMACTION__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int PLATFORMACTION__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int PLATFORMACTION__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int PLATFORMACTION__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int PLATFORMACTION__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int PLATFORMACTION__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int PLATFORMACTION__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int PLATFORMACTION__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            // IDs for classifiers for class PlatformElement 

            static const int PLATFORMELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int PLATFORMELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int PLATFORMELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int PLATFORMELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int PLATFORMELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int PLATFORMELEMENT__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int PLATFORMELEMENT__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int PLATFORMELEMENT__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int PLATFORMELEMENT__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            // IDs for classifiers for class PlatformEvent 

            static const int PLATFORMEVENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int PLATFORMEVENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int PLATFORMEVENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int PLATFORMEVENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int PLATFORMEVENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int PLATFORMEVENT__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int PLATFORMEVENT__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int PLATFORMEVENT__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int PLATFORMEVENT__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            // IDs for classifiers for class PlatformModel 

            static const int PLATFORMMODEL__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int PLATFORMMODEL__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int PLATFORMMODEL__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int PLATFORMMODEL__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int PLATFORMMODEL__AUDIT =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__AUDIT;

            static const int PLATFORMMODEL__EXTENSIONFAMILY =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__EXTENSIONFAMILY;

            static const int PLATFORMMODEL__NAME =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__NAME;

            // IDs for classifiers for class PlatformRelationship 

            static const int PLATFORMRELATIONSHIP__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int PLATFORMRELATIONSHIP__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int PLATFORMRELATIONSHIP__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int PLATFORMRELATIONSHIP__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class Process 

            static const int PROCESS__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int PROCESS__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int PROCESS__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int PROCESS__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int PROCESS__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int PROCESS__SOURCE = ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int PROCESS__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int PROCESS__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int PROCESS__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            static const int PROCESS__PLATFORMELEMENT =
                    RESOURCETYPE__PLATFORMELEMENT;

            // IDs for classifiers for class ReadsResource 

            static const int READSRESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int READSRESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int READSRESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int READSRESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class Requires 

            static const int REQUIRES__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int REQUIRES__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int REQUIRES__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int REQUIRES__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class ResourceType 

            static const int RESOURCETYPE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int RESOURCETYPE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int RESOURCETYPE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int RESOURCETYPE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int RESOURCETYPE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int RESOURCETYPE__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int RESOURCETYPE__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int RESOURCETYPE__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int RESOURCETYPE__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            // IDs for classifiers for class RuntimeResource 

            static const int RUNTIMERESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int RUNTIMERESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int RUNTIMERESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int RUNTIMERESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int RUNTIMERESOURCE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int RUNTIMERESOURCE__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int RUNTIMERESOURCE__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int RUNTIMERESOURCE__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int RUNTIMERESOURCE__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            static const int RUNTIMERESOURCE__PLATFORMELEMENT =
                    RESOURCETYPE__PLATFORMELEMENT;

            // IDs for classifiers for class Spawns 

            static const int SPAWNS__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int SPAWNS__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int SPAWNS__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int SPAWNS__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class StreamResource 

            static const int STREAMRESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int STREAMRESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int STREAMRESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int STREAMRESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int STREAMRESOURCE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int STREAMRESOURCE__SOURCE =
                    ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int STREAMRESOURCE__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int STREAMRESOURCE__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int STREAMRESOURCE__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            static const int STREAMRESOURCE__PLATFORMELEMENT =
                    RESOURCETYPE__PLATFORMELEMENT;

            // IDs for classifiers for class Thread 

            static const int THREAD__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int THREAD__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int THREAD__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int THREAD__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int THREAD__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int THREAD__SOURCE = ABSTRACTPLATFORMELEMENT__SOURCE;

            static const int THREAD__RELATION =
                    ABSTRACTPLATFORMELEMENT__RELATION;

            static const int THREAD__ABSTRACTION =
                    ABSTRACTPLATFORMELEMENT__ABSTRACTION;

            static const int THREAD__IMPLEMENTATION =
                    ABSTRACTPLATFORMELEMENT__IMPLEMENTATION;

            static const int THREAD__PLATFORMELEMENT =
                    RESOURCETYPE__PLATFORMELEMENT;

            // IDs for classifiers for class WritesResource 

            static const int WRITESRESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int WRITESRESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int WRITESRESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int WRITESRESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;
        ...
        protected:
            ...
            static std::unique_ptr< PlatformPackage,
                    ::ecorecpp::PackageDeleter< PlatformPackage > > s_instance;

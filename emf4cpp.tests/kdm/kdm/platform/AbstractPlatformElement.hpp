...
namespace kdm
{
    ...
    public:
        ...
        const ::ecorecpp::mapping::EList< ::kdm::platform::AbstractPlatformRelationship >& getRelation () const;
        ::ecorecpp::mapping::EList< ::kdm::platform::AbstractPlatformRelationship >& getRelation ();

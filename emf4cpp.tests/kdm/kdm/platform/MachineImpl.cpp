        ...
        ::ecore::EBoolean _resolve)
{
    ...
    {
        _any = m_deployedComponent->asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::kdm::platform::PlatformPackage::MACHINE__DEPLOYEDRESOURCE:
    {
        _any = m_deployedResource->asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
...
::ecore::EClass_ptr Machine::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::platform::PlatformPackage* >(::kdm::platform::PlatformPackage::_instance().get())->getMachine();
    return _eclass;
}

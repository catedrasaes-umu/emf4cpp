        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::structure::StructurePackage::STRUCTURERELATIONSHIP__TO:
    {
        ...
        ::kdm::structure::StructureRelationship::setTo(_t1);
    }
        return;
    case ::kdm::structure::StructurePackage::STRUCTURERELATIONSHIP__FROM:
    {
        ::ecore::EObject_ptr _t0 = ::ecorecpp::mapping::any::any_cast
                < ::ecore::EObject_ptr > (_newValue);
        ::kdm::structure::AbstractStructureElement_ptr _t1 =
                dynamic_cast< ::kdm::structure::AbstractStructureElement* >(_t0.get()); /*/// std::dynamic_pointer_cast< ::kdm::structure::AbstractStructureElement >(_t0);*/
        ::kdm::structure::StructureRelationship::setFrom(_t1);
    }
        return;
...
::ecore::EClass_ptr StructureRelationship::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::structure::StructurePackage* >(::kdm::structure::StructurePackage::_instance().get())->getStructureRelationship();
    return _eclass;
}

...
namespace kdm
{
    namespace structure
    {
        ...
        class StructurePackage: public virtual ::ecore::EPackage
        {
        public:
            ...
            static const int ABSTRACTSTRUCTUREELEMENT__STRUCTURERELATIONSHIP =
                    265;
            ...
            static const int ABSTRACTSTRUCTUREELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ABSTRACTSTRUCTUREELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ABSTRACTSTRUCTUREELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ABSTRACTSTRUCTUREELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int ABSTRACTSTRUCTUREELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            // IDs for classifiers for class AbstractStructureRelationship 

            static const int ABSTRACTSTRUCTURERELATIONSHIP__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ABSTRACTSTRUCTURERELATIONSHIP__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ABSTRACTSTRUCTURERELATIONSHIP__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ABSTRACTSTRUCTURERELATIONSHIP__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class ArchitectureView 

            static const int ARCHITECTUREVIEW__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ARCHITECTUREVIEW__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ARCHITECTUREVIEW__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ARCHITECTUREVIEW__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int ARCHITECTUREVIEW__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int ARCHITECTUREVIEW__AGGREGATED =
                    ABSTRACTSTRUCTUREELEMENT__AGGREGATED;

            static const int ARCHITECTUREVIEW__IMPLEMENTATION =
                    ABSTRACTSTRUCTUREELEMENT__IMPLEMENTATION;

            static const int ARCHITECTUREVIEW__STRUCTUREELEMENT =
                    ABSTRACTSTRUCTUREELEMENT__STRUCTUREELEMENT;

            static const int ARCHITECTUREVIEW__STRUCTURERELATIONSHIP =
                    ABSTRACTSTRUCTUREELEMENT__STRUCTURERELATIONSHIP;

            // IDs for classifiers for class Component 

            static const int COMPONENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int COMPONENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int COMPONENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int COMPONENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int COMPONENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int COMPONENT__AGGREGATED =
                    ABSTRACTSTRUCTUREELEMENT__AGGREGATED;

            static const int COMPONENT__IMPLEMENTATION =
                    ABSTRACTSTRUCTUREELEMENT__IMPLEMENTATION;

            static const int COMPONENT__STRUCTUREELEMENT =
                    ABSTRACTSTRUCTUREELEMENT__STRUCTUREELEMENT;

            static const int COMPONENT__STRUCTURERELATIONSHIP =
                    ABSTRACTSTRUCTUREELEMENT__STRUCTURERELATIONSHIP;

            // IDs for classifiers for class Layer 

            static const int LAYER__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int LAYER__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int LAYER__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int LAYER__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int LAYER__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int LAYER__AGGREGATED =
                    ABSTRACTSTRUCTUREELEMENT__AGGREGATED;

            static const int LAYER__IMPLEMENTATION =
                    ABSTRACTSTRUCTUREELEMENT__IMPLEMENTATION;

            static const int LAYER__STRUCTUREELEMENT =
                    ABSTRACTSTRUCTUREELEMENT__STRUCTUREELEMENT;

            static const int LAYER__STRUCTURERELATIONSHIP =
                    ABSTRACTSTRUCTUREELEMENT__STRUCTURERELATIONSHIP;

            // IDs for classifiers for class SoftwareSystem 

            static const int SOFTWARESYSTEM__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int SOFTWARESYSTEM__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int SOFTWARESYSTEM__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int SOFTWARESYSTEM__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int SOFTWARESYSTEM__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int SOFTWARESYSTEM__AGGREGATED =
                    ABSTRACTSTRUCTUREELEMENT__AGGREGATED;

            static const int SOFTWARESYSTEM__IMPLEMENTATION =
                    ABSTRACTSTRUCTUREELEMENT__IMPLEMENTATION;

            static const int SOFTWARESYSTEM__STRUCTUREELEMENT =
                    ABSTRACTSTRUCTUREELEMENT__STRUCTUREELEMENT;

            static const int SOFTWARESYSTEM__STRUCTURERELATIONSHIP =
                    ABSTRACTSTRUCTUREELEMENT__STRUCTURERELATIONSHIP;

            // IDs for classifiers for class StructureElement 

            static const int STRUCTUREELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int STRUCTUREELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int STRUCTUREELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int STRUCTUREELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int STRUCTUREELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int STRUCTUREELEMENT__AGGREGATED =
                    ABSTRACTSTRUCTUREELEMENT__AGGREGATED;

            static const int STRUCTUREELEMENT__IMPLEMENTATION =
                    ABSTRACTSTRUCTUREELEMENT__IMPLEMENTATION;

            static const int STRUCTUREELEMENT__STRUCTUREELEMENT =
                    ABSTRACTSTRUCTUREELEMENT__STRUCTUREELEMENT;

            static const int STRUCTUREELEMENT__STRUCTURERELATIONSHIP =
                    ABSTRACTSTRUCTUREELEMENT__STRUCTURERELATIONSHIP;

            // IDs for classifiers for class StructureModel 

            static const int STRUCTUREMODEL__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int STRUCTUREMODEL__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int STRUCTUREMODEL__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int STRUCTUREMODEL__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int STRUCTUREMODEL__AUDIT =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__AUDIT;

            static const int STRUCTUREMODEL__EXTENSIONFAMILY =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__EXTENSIONFAMILY;

            static const int STRUCTUREMODEL__NAME =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__NAME;

            // IDs for classifiers for class StructureRelationship 

            static const int STRUCTURERELATIONSHIP__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int STRUCTURERELATIONSHIP__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int STRUCTURERELATIONSHIP__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int STRUCTURERELATIONSHIP__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class Subsystem 

            static const int SUBSYSTEM__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int SUBSYSTEM__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int SUBSYSTEM__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int SUBSYSTEM__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int SUBSYSTEM__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int SUBSYSTEM__AGGREGATED =
                    ABSTRACTSTRUCTUREELEMENT__AGGREGATED;

            static const int SUBSYSTEM__IMPLEMENTATION =
                    ABSTRACTSTRUCTUREELEMENT__IMPLEMENTATION;

            static const int SUBSYSTEM__STRUCTUREELEMENT =
                    ABSTRACTSTRUCTUREELEMENT__STRUCTUREELEMENT;

            static const int SUBSYSTEM__STRUCTURERELATIONSHIP =
                    ABSTRACTSTRUCTUREELEMENT__STRUCTURERELATIONSHIP;
        ...
        protected:
            ...
            static std::unique_ptr< StructurePackage,
                    ::ecorecpp::PackageDeleter< StructurePackage > > s_instance;

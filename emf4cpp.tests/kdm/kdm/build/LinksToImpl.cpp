        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::build::BuildPackage::LINKSTO__FROM:
    {
        ::ecore::EObject_ptr _t0 = ::ecorecpp::mapping::any::any_cast<
                ::ecore::EObject_ptr >(_newValue);
        ::kdm::build::SymbolicLink_ptr _t1 =
                dynamic_cast< ::kdm::build::SymbolicLink_ptr > (_t0);
        ::kdm::build::LinksTo::setFrom(_t1);
    }
        return;
...
::ecore::EClass_ptr LinksTo::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kdm::build::BuildPackage_ptr > (::kdm::build::BuildPackage::_instance())->getLinksTo();
    return _eclass;
}

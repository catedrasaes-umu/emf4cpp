...
namespace kdm
{
    namespace build
    {
        ...
        class BuildPackage: public virtual ::ecore::EPackage
        {
        public:
            ...
            static const int ABSTRACTBUILDELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ABSTRACTBUILDELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ABSTRACTBUILDELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ABSTRACTBUILDELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int ABSTRACTBUILDELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            // IDs for classifiers for class AbstractBuildRelationship 

            static const int ABSTRACTBUILDRELATIONSHIP__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ABSTRACTBUILDRELATIONSHIP__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ABSTRACTBUILDRELATIONSHIP__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ABSTRACTBUILDRELATIONSHIP__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class BuildComponent 

            static const int BUILDCOMPONENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int BUILDCOMPONENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int BUILDCOMPONENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int BUILDCOMPONENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int BUILDCOMPONENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int BUILDCOMPONENT__BUILDRELATION =
                    ABSTRACTBUILDELEMENT__BUILDRELATION;

            static const int BUILDCOMPONENT__IMPLEMENTATION =
                    BUILDRESOURCE__IMPLEMENTATION;

            static const int BUILDCOMPONENT__GROUPEDBUILD =
                    BUILDRESOURCE__GROUPEDBUILD;

            static const int BUILDCOMPONENT__BUILDELEMENT =
                    BUILDRESOURCE__BUILDELEMENT;

            // IDs for classifiers for class BuildDescription 

            static const int BUILDDESCRIPTION__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int BUILDDESCRIPTION__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int BUILDDESCRIPTION__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int BUILDDESCRIPTION__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int BUILDDESCRIPTION__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int BUILDDESCRIPTION__BUILDRELATION =
                    ABSTRACTBUILDELEMENT__BUILDRELATION;

            static const int BUILDDESCRIPTION__IMPLEMENTATION =
                    BUILDRESOURCE__IMPLEMENTATION;

            static const int BUILDDESCRIPTION__GROUPEDBUILD =
                    BUILDRESOURCE__GROUPEDBUILD;

            static const int BUILDDESCRIPTION__BUILDELEMENT =
                    BUILDRESOURCE__BUILDELEMENT;

            // IDs for classifiers for class BuildElement 

            static const int BUILDELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int BUILDELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int BUILDELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int BUILDELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int BUILDELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int BUILDELEMENT__BUILDRELATION =
                    ABSTRACTBUILDELEMENT__BUILDRELATION;

            // IDs for classifiers for class BuildModel 

            static const int BUILDMODEL__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int BUILDMODEL__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int BUILDMODEL__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int BUILDMODEL__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int BUILDMODEL__AUDIT =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__AUDIT;

            static const int BUILDMODEL__EXTENSIONFAMILY =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__EXTENSIONFAMILY;

            static const int BUILDMODEL__NAME =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__NAME;

            // IDs for classifiers for class BuildProduct 

            static const int BUILDPRODUCT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int BUILDPRODUCT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int BUILDPRODUCT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int BUILDPRODUCT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int BUILDPRODUCT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int BUILDPRODUCT__BUILDRELATION =
                    ABSTRACTBUILDELEMENT__BUILDRELATION;

            static const int BUILDPRODUCT__IMPLEMENTATION =
                    BUILDRESOURCE__IMPLEMENTATION;

            static const int BUILDPRODUCT__GROUPEDBUILD =
                    BUILDRESOURCE__GROUPEDBUILD;

            static const int BUILDPRODUCT__BUILDELEMENT =
                    BUILDRESOURCE__BUILDELEMENT;

            // IDs for classifiers for class BuildRelationship 

            static const int BUILDRELATIONSHIP__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int BUILDRELATIONSHIP__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int BUILDRELATIONSHIP__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int BUILDRELATIONSHIP__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class BuildResource 

            static const int BUILDRESOURCE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int BUILDRESOURCE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int BUILDRESOURCE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int BUILDRESOURCE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int BUILDRESOURCE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int BUILDRESOURCE__BUILDRELATION =
                    ABSTRACTBUILDELEMENT__BUILDRELATION;

            // IDs for classifiers for class BuildStep 

            static const int BUILDSTEP__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int BUILDSTEP__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int BUILDSTEP__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int BUILDSTEP__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int BUILDSTEP__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int BUILDSTEP__BUILDRELATION =
                    ABSTRACTBUILDELEMENT__BUILDRELATION;

            static const int BUILDSTEP__IMPLEMENTATION =
                    BUILDRESOURCE__IMPLEMENTATION;

            static const int BUILDSTEP__GROUPEDBUILD =
                    BUILDRESOURCE__GROUPEDBUILD;

            static const int BUILDSTEP__BUILDELEMENT =
                    BUILDRESOURCE__BUILDELEMENT;

            // IDs for classifiers for class Consumes 

            static const int CONSUMES__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CONSUMES__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CONSUMES__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CONSUMES__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class DescribedBy 

            static const int DESCRIBEDBY__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int DESCRIBEDBY__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int DESCRIBEDBY__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int DESCRIBEDBY__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class Library 

            static const int LIBRARY__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int LIBRARY__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int LIBRARY__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int LIBRARY__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int LIBRARY__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int LIBRARY__BUILDRELATION =
                    ABSTRACTBUILDELEMENT__BUILDRELATION;
            ...
            static const int LINKSTO__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int LINKSTO__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int LINKSTO__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int LINKSTO__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class Produces 

            static const int PRODUCES__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int PRODUCES__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int PRODUCES__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int PRODUCES__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class SuppliedBy 

            static const int SUPPLIEDBY__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int SUPPLIEDBY__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int SUPPLIEDBY__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int SUPPLIEDBY__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class Supplier 

            static const int SUPPLIER__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int SUPPLIER__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int SUPPLIER__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int SUPPLIER__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int SUPPLIER__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int SUPPLIER__BUILDRELATION =
                    ABSTRACTBUILDELEMENT__BUILDRELATION;

            // IDs for classifiers for class SupportedBy 

            static const int SUPPORTEDBY__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int SUPPORTEDBY__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int SUPPORTEDBY__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int SUPPORTEDBY__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class SymbolicLink 

            static const int SYMBOLICLINK__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int SYMBOLICLINK__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int SYMBOLICLINK__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int SYMBOLICLINK__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int SYMBOLICLINK__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int SYMBOLICLINK__BUILDRELATION =
                    ABSTRACTBUILDELEMENT__BUILDRELATION;

            // IDs for classifiers for class Tool 

            static const int TOOL__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int TOOL__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int TOOL__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int TOOL__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int TOOL__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int TOOL__BUILDRELATION =
                    ABSTRACTBUILDELEMENT__BUILDRELATION;
        ...
        protected:
            ...
            static std::unique_ptr< BuildPackage,
                    ::ecorecpp::PackageDeleter< BuildPackage > > s_instance;

...
namespace kdm
{
    ...
    public:
        ...
        // References
        const ::ecorecpp::mapping::EList< ::kdm::code::ParameterUnit >& getParameterUnit () const;
    ...
    protected:
        ...
        ::ecorecpp::mapping::out_ptr< ::ecorecpp::mapping::EList< ::kdm::code::ParameterUnit > > m_parameterUnit;

        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::code::CodePackage::MODULE__CODEELEMENT:
    {
        ::ecorecpp::mapping::EList_ptr _t0 = ::ecorecpp::mapping::any::any_cast
                < ::ecorecpp::mapping::EList_ptr > (_newValue);
        ::kdm::code::Module::getCodeElement().clear();
        ::kdm::code::Module::getCodeElement().insert_all(*_t0);
    }
        return;
...
::ecore::EClass_ptr CodeAssembly::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::code::CodePackage_ptr >(::kdm::code::CodePackage::_instance())->getCodeAssembly();
    return _eclass;
}

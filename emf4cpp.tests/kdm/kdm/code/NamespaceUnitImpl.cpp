        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::code::CodePackage::NAMESPACEUNIT__GROUPEDCODE:
    {
        ::ecorecpp::mapping::EList< ::ecore::EObject_ptr >::ptr_type _t0 =
                ::ecorecpp::mapping::any::any_cast < ::ecorecpp::mapping::EList
                        < ::ecore::EObject_ptr > ::ptr_type > (_newValue);
        ::kdm::code::NamespaceUnit::getGroupedCode().clear();
        ::kdm::code::NamespaceUnit::getGroupedCode().insert_all(*_t0);
    }
        return;
...
::ecore::EClass_ptr NamespaceUnit::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::code::CodePackage* >(::kdm::code::CodePackage::_instance().get())->getNamespaceUnit();
    return _eclass;
}

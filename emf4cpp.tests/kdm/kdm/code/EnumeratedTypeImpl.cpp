        ...
        ::ecore::EBoolean _resolve)
{
    ...
    {
        _any = m_value->asEListOf< ::ecore::EObject > ();
    }
        return _any;
        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::code::CodePackage::ENUMERATEDTYPE__VALUE:
    {
        ::ecorecpp::mapping::EList_ptr _t0 =
                ::ecorecpp::mapping::any::any_cast<
                        ::ecorecpp::mapping::EList_ptr >(_newValue);
        ::kdm::code::EnumeratedType::getValue().clear();
        ::kdm::code::EnumeratedType::getValue().insert_all(*_t0);
    }
        return;
...
::ecore::EClass_ptr EnumeratedType::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kdm::code::CodePackage_ptr > (::kdm::code::CodePackage::_instance())->getEnumeratedType();
    return _eclass;
}

        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::code::CodePackage::INTERFACEUNIT__CODEELEMENT:
    {
        ::ecorecpp::mapping::EList_ptr _t0 = ::ecorecpp::mapping::any::any_cast
                < ::ecorecpp::mapping::EList_ptr > (_newValue);
        ::kdm::code::InterfaceUnit::getCodeElement().clear();
        ::kdm::code::InterfaceUnit::getCodeElement().insert_all(*_t0);
    }
        return;
...
::ecore::EClass_ptr InterfaceUnit::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::code::CodePackage_ptr >(::kdm::code::CodePackage::_instance())->getInterfaceUnit();
    return _eclass;
}

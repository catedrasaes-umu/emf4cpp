        ...
        ::ecore::EBoolean _resolve)
{
    ...
    {
        ::ecorecpp::mapping::any_traits< ::kdm::code::ParameterKind >::toAny(
                _any, m_kind);
    }
        return _any;
        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::code::CodePackage::PARAMETERUNIT__KIND:
    {
        ::ecorecpp::mapping::any_traits< ::kdm::code::ParameterKind >::fromAny(
                _newValue, m_kind);
    }
        return;
    case ::kdm::code::CodePackage::PARAMETERUNIT__POS:
...
::ecore::EBoolean ParameterUnit::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::kdm::code::CodePackage::PARAMETERUNIT__KIND:
        return ::ecorecpp::mapping::set_traits< ::kdm::code::ParameterKind >::is_set(
                m_kind);
    case ::kdm::code::CodePackage::PARAMETERUNIT__POS:
        return ::ecorecpp::mapping::set_traits< ::kdm::core::Integer >::is_set(
                m_pos);
...
::ecore::EClass_ptr ParameterUnit::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kdm::code::CodePackage_ptr > (::kdm::code::CodePackage::_instance())->getParameterUnit();
    return _eclass;
}

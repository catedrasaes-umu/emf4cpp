...
void GeneratedFrom::setTo(::kdm::code::PreprocessorDirective_ptr _to)
{
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ...
                (::ecore::EStructuralFeature_ptr) ::kdm::code::CodePackage::_instance()->getGeneratedFrom__to(),
                _old_to,
                m_to
        );
...
void GeneratedFrom::setFrom(::kdm::code::AbstractCodeElement_ptr _from)
{
    ...
    if (eNotificationRequired())
    {
        ::ecorecpp::notify::Notification notification(
                ::ecorecpp::notify::Notification::SET,
                (::ecore::EObject_ptr) this,
                (::ecore::EStructuralFeature_ptr) ::kdm::code::CodePackage::_instance()->getGeneratedFrom__from(),
                _old_from,
                m_from
        );
        eNotify(&notification);

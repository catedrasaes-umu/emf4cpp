        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::code::CodePackage::TEMPLATEUNIT__CODEELEMENT:
    {
        ::ecorecpp::mapping::EList_ptr _t0 = ::ecorecpp::mapping::any::any_cast
                < ::ecorecpp::mapping::EList_ptr > (_newValue);
        ::kdm::code::TemplateUnit::getCodeElement().clear();
        ::kdm::code::TemplateUnit::getCodeElement().insert_all(*_t0);
    }
        return;
...
::ecore::EClass_ptr TemplateUnit::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::code::CodePackage_ptr >(::kdm::code::CodePackage::_instance())->getTemplateUnit();
    return _eclass;
}

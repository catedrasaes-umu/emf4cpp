        ...
        ::ecore::EBoolean _resolve)
{
    ...
    {
        ::ecorecpp::mapping::any_traits< ::kdm::code::StorableKind >::toAny(
                _any, m_kind);
    }
        return _any;
        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::code::CodePackage::STORABLEUNIT__KIND:
    {
        ::ecorecpp::mapping::any_traits< ::kdm::code::StorableKind >::fromAny(
                _newValue, m_kind);
    }
        return;
...
::ecore::EBoolean StorableUnit::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::kdm::code::CodePackage::STORABLEUNIT__KIND:
        return ::ecorecpp::mapping::set_traits< ::kdm::code::StorableKind >::is_set(
                m_kind);
...
::ecore::EClass_ptr StorableUnit::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kdm::code::CodePackage_ptr > (::kdm::code::CodePackage::_instance())->getStorableUnit();
    return _eclass;
}

        ...
        ::ecore::EBoolean _resolve)
{
    ...
    {
        ::ecorecpp::mapping::any_traits< ::kdm::code::MethodKind >::toAny(_any,
                m_kind);
    }
        return _any;
        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::code::CodePackage::METHODUNIT__KIND:
    {
        ::ecorecpp::mapping::any_traits< ::kdm::code::MethodKind >::fromAny(
                _newValue, m_kind);
    }
        return;
    case ::kdm::code::CodePackage::METHODUNIT__EXPORT:
...
::ecore::EBoolean MethodUnit::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::kdm::code::CodePackage::METHODUNIT__KIND:
        return ::ecorecpp::mapping::set_traits< ::kdm::code::MethodKind >::is_set(
                m_kind);
    case ::kdm::code::CodePackage::METHODUNIT__EXPORT:
...
::ecore::EClass_ptr MethodUnit::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kdm::code::CodePackage_ptr > (::kdm::code::CodePackage::_instance())->getMethodUnit();
    return _eclass;
}

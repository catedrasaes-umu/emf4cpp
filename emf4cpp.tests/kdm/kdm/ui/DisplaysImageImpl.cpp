        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::ui::UiPackage::DISPLAYSIMAGE__TO:
    {
        ...
        ::kdm::source::Image_ptr _t1 =
                dynamic_cast< ::kdm::source::Image* >(_t0.get()); /*/// std::dynamic_pointer_cast< ::kdm::source::Image >(_t0);*/
        ::kdm::ui::DisplaysImage::setTo(_t1);
    }
        return;
    case ::kdm::ui::UiPackage::DISPLAYSIMAGE__FROM:
    {
        ...
        ::kdm::ui::DisplaysImage::setFrom(_t1);
    }
        return;
...
::ecore::EClass_ptr DisplaysImage::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::ui::UiPackage* >(::kdm::ui::UiPackage::_instance().get())->getDisplaysImage();
    return _eclass;
}

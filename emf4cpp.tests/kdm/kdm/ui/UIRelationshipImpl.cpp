        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::ui::UiPackage::UIRELATIONSHIP__TO:
    {
        ...
        ::kdm::ui::UIRelationship::setTo(_t1);
    }
        return;
    case ::kdm::ui::UiPackage::UIRELATIONSHIP__FROM:
    {
        ...
        ::kdm::ui::AbstractUIElement_ptr _t1 =
                dynamic_cast< ::kdm::ui::AbstractUIElement* >(_t0.get()); /*/// std::dynamic_pointer_cast< ::kdm::ui::AbstractUIElement >(_t0);*/
        ::kdm::ui::UIRelationship::setFrom(_t1);
    }
        return;
...
::ecore::EClass_ptr UIRelationship::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::ui::UiPackage* >(::kdm::ui::UiPackage::_instance().get())->getUIRelationship();
    return _eclass;
}

...
namespace kdm
{
    namespace conceptual
    {
        ...
        class ConceptualPackage: public virtual ::ecore::EPackage
        {
        public:
            ...
            static const int ABSTRACTCONCEPTUALELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ABSTRACTCONCEPTUALELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ABSTRACTCONCEPTUALELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ABSTRACTCONCEPTUALELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int ABSTRACTCONCEPTUALELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            // IDs for classifiers for class AbstractConceptualRelationship 

            static const int ABSTRACTCONCEPTUALRELATIONSHIP__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int ABSTRACTCONCEPTUALRELATIONSHIP__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int ABSTRACTCONCEPTUALRELATIONSHIP__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int ABSTRACTCONCEPTUALRELATIONSHIP__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class BehaviorUnit 

            static const int BEHAVIORUNIT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int BEHAVIORUNIT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int BEHAVIORUNIT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int BEHAVIORUNIT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int BEHAVIORUNIT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int BEHAVIORUNIT__SOURCE =
                    ABSTRACTCONCEPTUALELEMENT__SOURCE;

            static const int BEHAVIORUNIT__IMPLEMENTATION =
                    ABSTRACTCONCEPTUALELEMENT__IMPLEMENTATION;

            static const int BEHAVIORUNIT__CONCEPTUALRELATION =
                    ABSTRACTCONCEPTUALELEMENT__CONCEPTUALRELATION;

            static const int BEHAVIORUNIT__ABSTRACTION =
                    ABSTRACTCONCEPTUALELEMENT__ABSTRACTION;

            static const int BEHAVIORUNIT__CONCEPTUALELEMENT =
                    CONCEPTUALCONTAINER__CONCEPTUALELEMENT;

            // IDs for classifiers for class ConceptualContainer 

            static const int CONCEPTUALCONTAINER__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CONCEPTUALCONTAINER__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CONCEPTUALCONTAINER__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CONCEPTUALCONTAINER__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int CONCEPTUALCONTAINER__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int CONCEPTUALCONTAINER__SOURCE =
                    ABSTRACTCONCEPTUALELEMENT__SOURCE;

            static const int CONCEPTUALCONTAINER__IMPLEMENTATION =
                    ABSTRACTCONCEPTUALELEMENT__IMPLEMENTATION;

            static const int CONCEPTUALCONTAINER__CONCEPTUALRELATION =
                    ABSTRACTCONCEPTUALELEMENT__CONCEPTUALRELATION;

            static const int CONCEPTUALCONTAINER__ABSTRACTION =
                    ABSTRACTCONCEPTUALELEMENT__ABSTRACTION;

            // IDs for classifiers for class ConceptualElement 

            static const int CONCEPTUALELEMENT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CONCEPTUALELEMENT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CONCEPTUALELEMENT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CONCEPTUALELEMENT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int CONCEPTUALELEMENT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int CONCEPTUALELEMENT__SOURCE =
                    ABSTRACTCONCEPTUALELEMENT__SOURCE;

            static const int CONCEPTUALELEMENT__IMPLEMENTATION =
                    ABSTRACTCONCEPTUALELEMENT__IMPLEMENTATION;

            static const int CONCEPTUALELEMENT__CONCEPTUALRELATION =
                    ABSTRACTCONCEPTUALELEMENT__CONCEPTUALRELATION;

            static const int CONCEPTUALELEMENT__ABSTRACTION =
                    ABSTRACTCONCEPTUALELEMENT__ABSTRACTION;

            // IDs for classifiers for class ConceptualFlow 

            static const int CONCEPTUALFLOW__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CONCEPTUALFLOW__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CONCEPTUALFLOW__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CONCEPTUALFLOW__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class ConceptualModel 

            static const int CONCEPTUALMODEL__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CONCEPTUALMODEL__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CONCEPTUALMODEL__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CONCEPTUALMODEL__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int CONCEPTUALMODEL__AUDIT =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__AUDIT;

            static const int CONCEPTUALMODEL__EXTENSIONFAMILY =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__EXTENSIONFAMILY;

            static const int CONCEPTUALMODEL__NAME =
                    ::kdm::kdm::KdmPackage::KDMFRAMEWORK__NAME;

            // IDs for classifiers for class ConceptualRelationship 

            static const int CONCEPTUALRELATIONSHIP__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CONCEPTUALRELATIONSHIP__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CONCEPTUALRELATIONSHIP__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CONCEPTUALRELATIONSHIP__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            // IDs for classifiers for class ConceptualRole 

            static const int CONCEPTUALROLE__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int CONCEPTUALROLE__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int CONCEPTUALROLE__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int CONCEPTUALROLE__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int CONCEPTUALROLE__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int CONCEPTUALROLE__SOURCE =
                    ABSTRACTCONCEPTUALELEMENT__SOURCE;

            static const int CONCEPTUALROLE__IMPLEMENTATION =
                    ABSTRACTCONCEPTUALELEMENT__IMPLEMENTATION;

            static const int CONCEPTUALROLE__CONCEPTUALRELATION =
                    ABSTRACTCONCEPTUALELEMENT__CONCEPTUALRELATION;

            static const int CONCEPTUALROLE__ABSTRACTION =
                    ABSTRACTCONCEPTUALELEMENT__ABSTRACTION;

            // IDs for classifiers for class FactUnit 

            static const int FACTUNIT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int FACTUNIT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int FACTUNIT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int FACTUNIT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int FACTUNIT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int FACTUNIT__SOURCE =
                    ABSTRACTCONCEPTUALELEMENT__SOURCE;

            static const int FACTUNIT__IMPLEMENTATION =
                    ABSTRACTCONCEPTUALELEMENT__IMPLEMENTATION;

            static const int FACTUNIT__CONCEPTUALRELATION =
                    ABSTRACTCONCEPTUALELEMENT__CONCEPTUALRELATION;

            static const int FACTUNIT__ABSTRACTION =
                    ABSTRACTCONCEPTUALELEMENT__ABSTRACTION;

            static const int FACTUNIT__CONCEPTUALELEMENT =
                    CONCEPTUALCONTAINER__CONCEPTUALELEMENT;

            // IDs for classifiers for class RuleUnit 

            static const int RULEUNIT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int RULEUNIT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int RULEUNIT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int RULEUNIT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int RULEUNIT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int RULEUNIT__SOURCE =
                    ABSTRACTCONCEPTUALELEMENT__SOURCE;

            static const int RULEUNIT__IMPLEMENTATION =
                    ABSTRACTCONCEPTUALELEMENT__IMPLEMENTATION;

            static const int RULEUNIT__CONCEPTUALRELATION =
                    ABSTRACTCONCEPTUALELEMENT__CONCEPTUALRELATION;

            static const int RULEUNIT__ABSTRACTION =
                    ABSTRACTCONCEPTUALELEMENT__ABSTRACTION;

            static const int RULEUNIT__CONCEPTUALELEMENT =
                    CONCEPTUALCONTAINER__CONCEPTUALELEMENT;

            // IDs for classifiers for class ScenarioUnit 

            static const int SCENARIOUNIT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int SCENARIOUNIT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int SCENARIOUNIT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int SCENARIOUNIT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int SCENARIOUNIT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int SCENARIOUNIT__SOURCE =
                    ABSTRACTCONCEPTUALELEMENT__SOURCE;

            static const int SCENARIOUNIT__IMPLEMENTATION =
                    ABSTRACTCONCEPTUALELEMENT__IMPLEMENTATION;

            static const int SCENARIOUNIT__CONCEPTUALRELATION =
                    ABSTRACTCONCEPTUALELEMENT__CONCEPTUALRELATION;

            static const int SCENARIOUNIT__ABSTRACTION =
                    ABSTRACTCONCEPTUALELEMENT__ABSTRACTION;

            static const int SCENARIOUNIT__CONCEPTUALELEMENT =
                    CONCEPTUALCONTAINER__CONCEPTUALELEMENT;

            // IDs for classifiers for class TermUnit 

            static const int TERMUNIT__ATTRIBUTE =
                    ::kdm::core::CorePackage::ELEMENT__ATTRIBUTE;

            static const int TERMUNIT__ANNOTATION =
                    ::kdm::core::CorePackage::ELEMENT__ANNOTATION;

            static const int TERMUNIT__STEREOTYPE =
                    ::kdm::core::CorePackage::MODELELEMENT__STEREOTYPE;

            static const int TERMUNIT__TAGGEDVALUE =
                    ::kdm::core::CorePackage::MODELELEMENT__TAGGEDVALUE;

            static const int TERMUNIT__NAME =
                    ::kdm::core::CorePackage::KDMENTITY__NAME;

            static const int TERMUNIT__SOURCE =
                    ABSTRACTCONCEPTUALELEMENT__SOURCE;

            static const int TERMUNIT__IMPLEMENTATION =
                    ABSTRACTCONCEPTUALELEMENT__IMPLEMENTATION;

            static const int TERMUNIT__CONCEPTUALRELATION =
                    ABSTRACTCONCEPTUALELEMENT__CONCEPTUALRELATION;

            static const int TERMUNIT__ABSTRACTION =
                    ABSTRACTCONCEPTUALELEMENT__ABSTRACTION;

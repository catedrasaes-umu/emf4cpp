...
::ecore::EBoolean BehaviorUnit::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::kdm::conceptual::ConceptualPackage::CONCEPTUALCONTAINER__CONCEPTUALELEMENT:
        return m_conceptualElement && m_conceptualElement->size();
...
::ecore::EClass_ptr BehaviorUnit::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::conceptual::ConceptualPackage* >(::kdm::conceptual::ConceptualPackage::_instance().get())->getBehaviorUnit();
    return _eclass;
}

...
void EventModel::_initialize()
{
    ...
    for (size_t i = 0; i < m_eventElement->size(); i++)
    {
        ...
        (*m_eventElement)[i]->_setEContainer(
                this,
        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::event::EventPackage::EVENTMODEL__EVENTELEMENT:
    {
        ::ecorecpp::mapping::EList_ptr _t0 =
                ::ecorecpp::mapping::any::any_cast<
                        ::ecorecpp::mapping::EList_ptr >(_newValue);
        ::kdm::event::EventModel::getEventElement().clear();
        ::kdm::event::EventModel::getEventElement().insert_all(*_t0);
    }
        return;
...
::ecore::EClass_ptr EventModel::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kdm::event::EventPackage_ptr > (::kdm::event::EventPackage::_instance())->getEventModel();
    return _eclass;
}

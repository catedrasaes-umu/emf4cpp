        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::event::EventPackage::PRODUCESEVENT__TO:
    {
        ...
        ::kdm::event::Event_ptr _t1 =
                dynamic_cast< ::kdm::event::Event_ptr >(_t0);
        ::kdm::event::ProducesEvent::setTo(_t1);
    }
        return;
    case ::kdm::event::EventPackage::PRODUCESEVENT__FROM:
    {
        ...
        ::kdm::event::ProducesEvent::setFrom(_t1);
    }
        return;
...
::ecore::EClass_ptr ProducesEvent::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::event::EventPackage_ptr >(::kdm::event::EventPackage::_instance())->getProducesEvent();
    return _eclass;
}

        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::event::EventPackage::EVENTRELATIONSHIP__TO:
    {
        ...
        ::kdm::event::EventRelationship::setTo(_t1);
    }
        return;
    case ::kdm::event::EventPackage::EVENTRELATIONSHIP__FROM:
    {
        ::ecore::EObject_ptr _t0 = ::ecorecpp::mapping::any::any_cast
                < ::ecore::EObject_ptr > (_newValue);
        ::kdm::event::AbstractEventElement_ptr _t1 =
                dynamic_cast< ::kdm::event::AbstractEventElement* >(_t0.get()); /*/// std::dynamic_pointer_cast< ::kdm::event::AbstractEventElement >(_t0);*/
        ::kdm::event::EventRelationship::setFrom(_t1);
    }
        return;
...
::ecore::EClass_ptr EventRelationship::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::event::EventPackage* >(::kdm::event::EventPackage::_instance().get())->getEventRelationship();
    return _eclass;
}

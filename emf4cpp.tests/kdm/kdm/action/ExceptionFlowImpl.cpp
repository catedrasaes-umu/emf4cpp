        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::action::ActionPackage::EXCEPTIONFLOW__TO:
    {
        ...
        ::kdm::action::ExceptionFlow::setTo(_t1);
    }
        return;
    case ::kdm::action::ActionPackage::EXCEPTIONFLOW__FROM:
    {
        ...
        ::kdm::action::ActionElement_ptr _t1 =
                dynamic_cast< ::kdm::action::ActionElement_ptr >(_t0);
        ::kdm::action::ExceptionFlow::setFrom(_t1);
    }
        return;
...
::ecore::EClass_ptr ExceptionFlow::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::kdm::action::ActionPackage_ptr >(::kdm::action::ActionPackage::_instance())->getExceptionFlow();
    return _eclass;
}

...
void ConceptualContainer::_initialize()
{
    ...
    for (size_t i = 0; i < m_conceptualElement->size(); i++)
    {
        ...
        (*m_conceptualElement)[i]->_setEContainer(
                this,
...
::ecore::EClass_ptr ConceptualContainer::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kdm::conceptual::ConceptualPackage_ptr > (::kdm::conceptual::ConceptualPackage::_instance())->getConceptualContainer();
    return _eclass;
}

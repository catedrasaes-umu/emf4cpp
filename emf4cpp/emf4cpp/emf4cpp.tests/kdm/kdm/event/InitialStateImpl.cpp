        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::event::EventPackage::ABSTRACTEVENTELEMENT__IMPLEMENTATION:
    {
        ...
        ::kdm::event::AbstractEventElement::getImplementation().insert_all(*_t0);
    }
        return;
    case ::kdm::event::EventPackage::EVENTRESOURCE__EVENTELEMENT:
    {
...
::ecore::EClass_ptr InitialState::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kdm::event::EventPackage_ptr > (::kdm::event::EventPackage::_instance())->getInitialState();
    return _eclass;
}

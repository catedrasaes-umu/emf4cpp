        ...
        ::ecore::EBoolean _resolve)
{
    ...
    {
        ::ecorecpp::mapping::any_traits< ::kdm::code::MacroKind >::toAny(_any,
                m_kind);
    }
        return _any;
        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::code::CodePackage::MACROUNIT__KIND:
    {
        ::ecorecpp::mapping::any_traits< ::kdm::code::MacroKind >::fromAny(
                _newValue, m_kind);
    }
        return;
...
::ecore::EBoolean MacroUnit::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::kdm::code::CodePackage::MACROUNIT__KIND:
        return ::ecorecpp::mapping::set_traits< ::kdm::code::MacroKind >::is_set(
                m_kind);
...
::ecore::EClass_ptr MacroUnit::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kdm::code::CodePackage_ptr > (::kdm::code::CodePackage::_instance())->getMacroUnit();
    return _eclass;
}

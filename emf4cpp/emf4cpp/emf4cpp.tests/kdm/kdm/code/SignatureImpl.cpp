...
void Signature::_initialize()
{
    ...
    for (size_t i = 0; i < m_parameterUnit->size(); i++)
    {
        ...
        (*m_parameterUnit)[i]->_setEContainer(
                this,
        ...
        ::ecore::EBoolean _resolve)
{
    ...
    {
        _any = m_parameterUnit->asEListOf< ::ecore::EObject > ();
    }
        return _any;
        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::code::CodePackage::SIGNATURE__PARAMETERUNIT:
    {
        ::ecorecpp::mapping::EList_ptr _t0 =
                ::ecorecpp::mapping::any::any_cast<
                        ::ecorecpp::mapping::EList_ptr >(_newValue);
        ::kdm::code::Signature::getParameterUnit().clear();
        ::kdm::code::Signature::getParameterUnit().insert_all(*_t0);
    }
        return;
...
::ecore::EBoolean Signature::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::kdm::code::CodePackage::SIGNATURE__PARAMETERUNIT:
        return m_parameterUnit && m_parameterUnit->size();
...
::ecore::EClass_ptr Signature::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kdm::code::CodePackage_ptr > (::kdm::code::CodePackage::_instance())->getSignature();
    return _eclass;
}

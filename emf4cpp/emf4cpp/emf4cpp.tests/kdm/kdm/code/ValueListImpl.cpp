...
void ValueList::_initialize()
{
    ...
    for (size_t i = 0; i < m_valueElement->size(); i++)
    {
        ...
        (*m_valueElement)[i]->_setEContainer(
                this,
        ...
        ::ecore::EBoolean _resolve)
{
    ...
    {
        _any = m_valueElement->asEListOf< ::ecore::EObject > ();
    }
        return _any;
...
::ecore::EClass_ptr ValueList::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kdm::code::CodePackage_ptr > (::kdm::code::CodePackage::_instance())->getValueList();
    return _eclass;
}

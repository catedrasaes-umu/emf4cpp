        ...
        ::ecore::EBoolean _resolve)
{
    ...
    {
        _any = m_entryFlow->asEListOf< ::ecore::EObject > ();
    }
        return _any;
    ...
    {
        ::ecorecpp::mapping::any_traits< ::kdm::code::CallableKind >::toAny(
                _any, m_kind);
    }
        return _any;
        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::code::CodePackage::CONTROLELEMENT__TYPE:
    {
        ...
        ::kdm::code::ControlElement::setType(_t1);
    }
        return;
    case ::kdm::code::CodePackage::CONTROLELEMENT__ENTRYFLOW:
    {
        ::ecorecpp::mapping::EList_ptr _t0 =
                ::ecorecpp::mapping::any::any_cast<
                        ::ecorecpp::mapping::EList_ptr >(_newValue);
        ::kdm::code::ControlElement::getEntryFlow().clear();
        ::kdm::code::ControlElement::getEntryFlow().insert_all(*_t0);
    }
        return;
    case ::kdm::code::CodePackage::CONTROLELEMENT__CODEELEMENT:
    {
        ::ecorecpp::mapping::EList_ptr _t0 =
                ::ecorecpp::mapping::any::any_cast<
                        ::ecorecpp::mapping::EList_ptr >(_newValue);
        ::kdm::code::ControlElement::getCodeElement().clear();
        ::kdm::code::ControlElement::getCodeElement().insert_all(*_t0);
    }
        return;
    case ::kdm::code::CodePackage::CALLABLEUNIT__KIND:
    {
        ::ecorecpp::mapping::any_traits< ::kdm::code::CallableKind >::fromAny(
                _newValue, m_kind);
    }
        return;
...
::ecore::EBoolean CallableUnit::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::kdm::code::CodePackage::CONTROLELEMENT__TYPE:
        return m_type;
    case ::kdm::code::CodePackage::CONTROLELEMENT__ENTRYFLOW:
        return m_entryFlow && m_entryFlow->size();
    case ::kdm::code::CodePackage::CONTROLELEMENT__CODEELEMENT:
        return m_codeElement && m_codeElement->size();
    case ::kdm::code::CodePackage::CALLABLEUNIT__KIND:
        return ::ecorecpp::mapping::set_traits< ::kdm::code::CallableKind >::is_set(
                m_kind);
...
::ecore::EClass_ptr CallableUnit::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kdm::code::CodePackage_ptr > (::kdm::code::CodePackage::_instance())->getCallableUnit();
    return _eclass;
}

...
namespace xpand3
{
    namespace statement
    {
        ...
        class StatementPackage: public virtual ::ecore::EPackage
        {
        public:
            ...
            static const int ABSTRACTSTATEMENT__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int ABSTRACTSTATEMENT__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int ABSTRACTSTATEMENT__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int ABSTRACTSTATEMENT__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;

            // IDs for classifiers for class AbstractStatementWithBody 

            static const int ABSTRACTSTATEMENTWITHBODY__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int ABSTRACTSTATEMENTWITHBODY__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int ABSTRACTSTATEMENTWITHBODY__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int ABSTRACTSTATEMENTWITHBODY__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;

            // IDs for classifiers for class ErrorStatement 

            static const int ERRORSTATEMENT__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int ERRORSTATEMENT__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int ERRORSTATEMENT__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int ERRORSTATEMENT__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;

            // IDs for classifiers for class ExpandStatement 

            static const int EXPANDSTATEMENT__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int EXPANDSTATEMENT__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int EXPANDSTATEMENT__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int EXPANDSTATEMENT__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;

            // IDs for classifiers for class ExpressionStatement 

            static const int EXPRESSIONSTATEMENT__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int EXPRESSIONSTATEMENT__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int EXPRESSIONSTATEMENT__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int EXPRESSIONSTATEMENT__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;

            // IDs for classifiers for class FileStatement 

            static const int FILESTATEMENT__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int FILESTATEMENT__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int FILESTATEMENT__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int FILESTATEMENT__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;

            static const int FILESTATEMENT__BODY =
                    ABSTRACTSTATEMENTWITHBODY__BODY;

            // IDs for classifiers for class ForEachStatement 

            static const int FOREACHSTATEMENT__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int FOREACHSTATEMENT__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int FOREACHSTATEMENT__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int FOREACHSTATEMENT__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;

            static const int FOREACHSTATEMENT__BODY =
                    ABSTRACTSTATEMENTWITHBODY__BODY;

            // IDs for classifiers for class IfStatement 

            static const int IFSTATEMENT__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int IFSTATEMENT__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int IFSTATEMENT__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;
            ...
            static const int LETSTATEMENT__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int LETSTATEMENT__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int LETSTATEMENT__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int LETSTATEMENT__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;

            static const int LETSTATEMENT__BODY =
                    ABSTRACTSTATEMENTWITHBODY__BODY;

            // IDs for classifiers for class ProtectStatement 

            static const int PROTECTSTATEMENT__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int PROTECTSTATEMENT__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int PROTECTSTATEMENT__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int PROTECTSTATEMENT__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;

            static const int PROTECTSTATEMENT__BODY =
                    ABSTRACTSTATEMENTWITHBODY__BODY;

            // IDs for classifiers for class TextStatement 

            static const int TEXTSTATEMENT__LINE =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__LINE;

            static const int TEXTSTATEMENT__START =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__START;

            static const int TEXTSTATEMENT__END =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__END;

            static const int TEXTSTATEMENT__FILENAME =
                    ::xpand3::Xpand3Package::SYNTAXELEMENT__FILENAME;
